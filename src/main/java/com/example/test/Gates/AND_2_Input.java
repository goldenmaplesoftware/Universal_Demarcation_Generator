...
public class AND_2_Input<O, O1, O2, O3> {
    private static String gateName="AND Gate 2-Input";
    private final int gateNumber;
    private final boolean inputA; //1A
    private final boolean inputB; //1B
    private boolean outputY;       //1Y

    public AND_2_Input(String gateName, int gateNumber, boolean inputA, boolean inputB, boolean b)
    {
